...
<form class="form-horizontal"
	action="<?php echo url_for('revista/'.($form->getObject()->isNew() ? 'create' : 'update').(!$form->getObject()->isNew() ? '?id='.$form->getObject()->getId() : '')) ?>"
	method="post"
	...
	<div class="control-group">
		<div class="controls">
			...
			<?php if (!$form->getObject()->isNew()): ?>
<a href="<?php echo url_for('revista/agregarImagen?revistaId='.$form->getObject()->getId()) ?>" class="btn">Agregar Foto</a>
<?php endif;?>
		</div>
	</div>
</form>
	...
	<table class="lista table table-hover table-bordered">
		...
		<tbody>
			...
			<tr>
				...
				<td><?php echo $foto->getOrden() ?></td>
				<td><a
					href="<?php echo url_for('revista/editFoto?id='.$foto->getId()) ?>">Editar</a>

					<a
					href="<?php echo url_for('revista/deleteFoto?id='.$foto->getId()) ?>">Eliminar</a>
				</td>
			</tr>
			<?php endforeach; ?>
