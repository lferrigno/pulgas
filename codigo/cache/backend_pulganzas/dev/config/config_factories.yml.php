...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/home/rada/dev/pulgasWeb/pulgas/codigo/log/backend_pulganzas_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/home/rada/dev/pulgasWeb/pulgas/codigo/cache/backend_pulganzas/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/home/rada/dev/pulgasWeb/pulgas/codigo/apps/backend_pulganzas/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/home/rada/dev/pulgasWeb/pulgas/codigo/cache/backend_pulganzas/dev/template',
  'lifetime' => 86400,
  'prefix' => '/home/rada/dev/pulgasWeb/pulgas/codigo/apps/backend_pulganzas/template',
)));
